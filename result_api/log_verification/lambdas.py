...
def get_code_link(template):
    if "Unable to parse authorisation packet" in str(template):
        return "https://github.com/aiops/sockshop-demo/pull/81/files#diff-d85b981bd02613bc06ceaebfbcc2e1b6996208e2e17cf3adeb1db7d7ae1f6032L93"
        ...
        return "https://github.com/aiops/sockshop-demo/pull/81/files#diff-d85b981bd02613bc06ceaebfbcc2e1b6996208e2e17cf3adeb1db7d7ae1f6032R91"
    elif "Sending payment authorization response" in str(template):
        return "https://github.com/aiops/sockshop-demo/pull/81/files#diff-e5910214f12c159b0116375480dd90e8455229197a99d52b4c22093f8509ee2bR72"
    else:
        return ""
